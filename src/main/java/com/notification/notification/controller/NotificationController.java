...
public class NotificationController {
    ...
    public ResponseEntity<Page<NotificationResponse>> getNotifications(
        ...
        return ResponseEntity.ok(notificationService.getNotifications(authorizedMemberId(memberId), pageable));
    }

    @Operation(summary = "내 알림 목록 조회(me 별칭)", description = "프론트 하위호환용 엔드포인트")
    @GetMapping("/me")
    ...
    public ResponseEntity<UnreadCountResponse> getUnreadCount(
        ...
        return ResponseEntity.ok(notificationService.getUnreadCount(authorizedMemberId(memberId)));
    }

    @Operation(summary = "미읽음 알림 수 조회(me 별칭)", description = "프론트 하위호환용 엔드포인트")
    ...
    public ResponseEntity<Void> markAsRead(
        ...
        notificationService.markAsRead(authorizedMemberId(memberId), notificationId);
    ...
    public ResponseEntity<Void> markAllAsRead(
        ...
        notificationService.markAllAsRead(authorizedMemberId(memberId));
        return ResponseEntity.noContent().build();
    }
    ...
    public ResponseEntity<Void> deleteNotification(
        ...
        notificationService.deleteNotification(authorizedMemberId(memberId), notificationId);
        return ResponseEntity.noContent().build();
    }
    ...
    public ResponseEntity<Void> deleteAllNotifications(
        ...
        notificationService.deleteAllNotifications(authorizedMemberId(memberId));
        return ResponseEntity.noContent().build();
    }

    private Long authorizedMemberId(Long memberId) {
